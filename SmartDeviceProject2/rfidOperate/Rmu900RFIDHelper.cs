...
namespace RfidReader
{
    ...
    /// </summary>
    public class Rmu900RFIDHelper:IRFIDHelper
    {
        #region 常用命令字符串
        ...
        //public deleVoid_String_Func evtwriteToSerialPort;
        ...
        //public RFIDHelper(IDataTransfer _dataTransfer)
        ...
        {
            RMUisReady = false;
            this.WriteData(Rmu900RFIDHelper.RFIDCommand_RMU_GetStatus);
            RMUStatus.Reset();
